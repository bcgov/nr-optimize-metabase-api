...
write_xlsx(list("Path Details" = table_pathsize_tallyfiles, "Folder File Type Tally" = table_foldersize_tallyfiles, "Share File Type Tally" = table_sharesize_tallyfiles, "Duplicate Files" = duplicate_files_formatted, "Paths with Spaces" = pathname_spaces, "Long Paths" = sfp_data_long_path), path = here("output", output_excel))
```