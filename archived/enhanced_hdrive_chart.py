...
#
#
# usage: enhanced_hdrive_chart.py -i <input_directory> -d <YYYY-MM>
# example:  enhanced_hdrive_chart.py -i J:\Scripts\Python\Data -d 2022-05
# -------------------------------------------------------------------------------
...
def main(argv):
    ...
    cols = combined.columns.drop("Path", "Ministry")
    ...
    totalfilecount = (
        ...
        sum(combined["Default - File Count"]),
    )
    ...
    # Add Plot Title
    ax.set_title(
        """What's in NRM H: Drives - Quarterly Report """ + (datestamp),
        loc="left",
    )
