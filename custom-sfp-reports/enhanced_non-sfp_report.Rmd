...
# Subtract 2 because the folder depth count starts after the drive letter and 1 folder
table_pathsize_tallyfiles$FolderDepth <- table_pathsize_tallyfiles$FolderDepth - 2
...
output_excel = paste0("Non-SFP_Custom_Report_", params$folder, "_", params$businessarea, "_", params$collection, ".xlsx")
```
