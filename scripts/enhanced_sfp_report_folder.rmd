...
sfp_data <- fread((here("source", glue("{params$data}"))), fill = TRUE, select = c("filename", "path", "share", "sizemb", "lastaccessdate", "modificationdate", "creationdate"), na.strings=c("","NULL.NULL"))

setkey(sfp_data, path)[.({params$path})]
```
