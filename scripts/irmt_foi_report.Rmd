---
title: "SFP Enhanced Search - Special Report on S40203\\IRMT\\FOI"
subtitle: "Q3 - October 2020"
...
here::here()
sfp_enhanced <- read_csv(here("source", "2020-10-01_ENV_SFP_Enhanced_Data.csv"), col_names = TRUE)
```
...
# Subtract 6 because the folder depth count starts after \\SLEDGE\S40203\IRMT\FOI\
...
glue('The path \\\\\\SLEDGE\\S40203\\IRMT\\FOI has {folder_count} folders.')
```
...
glue('The average folder depth within \\\\\\SLEDGE\\S40203\\IRMT\\FOI is {mean_depth}.')
```
...
glue('The size of path \\\\\\SLEDGE\\S40203\\IRMT\\FOI is {share_size} GB.')
```
...
glue('The cost of path \\\\\\SLEDGE\\S40203\\IRMT\\FOI is ${share_cost}.')
```
...
glue('There are files saved in more than one location on \\\\\\SLEDGE\\S40203\\IRMT\\FOI that total a cost of ${dup_cost}. 
